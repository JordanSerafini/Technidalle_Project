...
-- Insertion des adresses pour le personnel (sans ID)
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '25' AND street_name = 'Rue des Roses' LIMIT 1),
    '2020-01-15', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '12' AND street_name = 'Avenue Jean Jaurès' LIMIT 1),
    '2020-03-01', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '8' AND street_name = 'Rue de la République' LIMIT 1),
    '2020-06-15', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '15' AND street_name = 'Rue de la Charité' LIMIT 1),
    '2021-01-10', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '78' AND street_name = 'Avenue de Saxe' LIMIT 1),
    '2021-09-01', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '3' AND street_name = 'Rue de la Bourse' LIMIT 1),
    '2021-11-15', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '56' AND street_name = 'Rue de la République' LIMIT 1),
    '2022-01-20', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '9' AND street_name = 'Place des Terreaux' LIMIT 1),
    '2022-03-10', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '112' AND street_name = 'Boulevard de la Guillotière' LIMIT 1),
    '2022-06-01', true
...
SELECT 
    ...
    (SELECT id FROM addresses WHERE street_number = '45' AND street_name = 'Boulevard de la Croix-Rousse' LIMIT 1),
    '2022-09-15', true
...
-- Insertion des adresses pour les clients (sans ID et avec address_id correct)
...
SELECT 
    ...
    (SELECT id FROM inserted_addresses LIMIT 1),
    '12345678901234', 'Client régulier depuis 2021';

-- Insertion des clients
INSERT INTO clients (company_name, firstname, lastname, email, phone, mobile, address_id, siret, notes) VALUES
('Groupe Habitat', 'Marie', 'Durand', 'm.durand@groupe-habitat.fr', '0472131415', '0623456789', 2, '23456789012345', 'Projets résidentiels haut de gamme'),
('Particulier', 'Pierre', 'Martin', 'p.martin@gmail.com', '0472151617', '0634567890', 3, NULL, 'Recommandé par ACME Immobilier'),
('Résidences Lyon', 'Sophie', 'Petit', 's.petit@residences-lyon.fr', '0472171819', '0645678901', 4, '34567890123456', 'Gestionnaire de résidences'),
('Particulier', 'Luc', 'Bernard', 'l.bernard@outlook.fr', '0472192021', '0656789012', 5, NULL, 'Appartement en rénovation complète'),
('LuxRenovation', 'Emma', 'Roux', 'e.roux@luxrenovation.fr', '0472212223', '0667890123', 6, '45678901234567', 'Partenaire sur projets de luxe'),
('Particulier', 'Thomas', 'Lefebvre', 't.lefebvre@gmail.com', '0472232425', '0678901234', 7, NULL, 'Maison neuve à équiper'),
('CityConstruct', 'Julie', 'Moreau', 'j.moreau@cityconstruct.fr', '0472252627', '0689012345', 8, '56789012345678', 'Projets urbains multiples'),
('Particulier', 'Antoine', 'Simon', 'a.simon@free.fr', '0472272829', '0690123456', 9, NULL, 'Rénovation salle de bain urgente'),
('Immobilière du Rhône', 'Claire', 'Dubois', 'c.dubois@immorhone.fr', '0472293031', '0601234567', 10, '67890123456789', 'Plusieurs immeubles en gestion')
ON CONFLICT (id) DO NOTHING;
...
('PRJ-2023-001', 'Rénovation appartement Montchat', 'Rénovation complète d''un appartement de 75m²', 1, 1, 'termine', '2023-10-01', '2023-11-15', 45, 45000.00, 43000.00, 2000.00, 2, 'Premier projet terminé avec succès'),
('PRJ-2023-002', 'Rénovation immeuble Les Trois Pins', 'Rénovation des parties communes et 2 appartements', 2, 2, 'termine', '2023-11-01', '2023-12-15', 45, 75000.00, 72000.00, 3000.00, 2, 'Projet terminé avec satisfaction'),
('PRJ-2023-003', 'Rénovation immeuble Belle Vue', 'Rénovation des parties communes et 4 appartements', 2, 2, 'termine', '2023-12-01', '2024-01-15', 45, 85000.00, 82000.00, 3000.00, 2, 'Projet terminé avec satisfaction'),
('PRJ-2023-004', 'Rénovation appartement Riviera', 'Rénovation d''un appartement de 90m²', 3, 3, 'termine', '2023-12-10', '2024-01-25', 45, 32000.00, 30500.00, 1500.00, 3, 'Projet terminé dans les délais'),
('PRJ-2024-001', 'Rénovation appartement Martin', 'Rénovation d''un appartement de 45m²', 4, 4, 'en_cours', '2024-01-15', '2024-02-28', 45, 15000.00, NULL, NULL, 3, 'En cours de réalisation'),
('PRJ-2024-009', 'Rénovation immeuble Les Roses', 'Rénovation des parties communes et 2 appartements', 5, 5, 'en_preparation', '2024-05-01', '2024-06-15', 45, 55000.00, NULL, NULL, 3, 'Projet en préparation'),
('PRJ-2024-010', 'Rénovation appartement Paris Centre', 'Rénovation d''un appartement de 110m²', 6, 6, 'devis_accepte', '2024-07-01', '2024-08-15', 45, 40000.00, NULL, NULL, 3, 'Devis accepté - en attente de planification')
ON CONFLICT (id) DO NOTHING;
