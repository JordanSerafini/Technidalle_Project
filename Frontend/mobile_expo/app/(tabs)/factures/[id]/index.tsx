  ...
  const renderContent = () => {
    ...
    return (
      <View style={{ paddingBottom: 100 }}>
        ...
        {/* Fichier associé pour la facture */}
        {document.file_path && document.type === 'facture' && (
          <View className="bg-white p-5 rounded-lg shadow-sm mb-4">
            ...
            >
              ...
              <Text className="ml-3 flex-1 text-blue-800">Ouvrir la facture</Text>
        ...
        {document.file_path && document.type !== 'photo_chantier' && document.type !== 'devis' && document.type !== 'facture' && (
          <View className="bg-white p-5 rounded-lg shadow-sm mb-4">
            <Text className="text-lg font-semibold text-gray-800 mb-3">Fichier associé</Text>
            <TouchableOpacity 
              className="flex-row items-center p-3 bg-blue-50 rounded-lg"
